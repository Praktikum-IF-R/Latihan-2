...
public class Larik {
	...
	public static Larik sambung(Larik l1, Larik l2) {
		int sizeHasil = l1.size + l2.size;
		double isi[] = new double[sizeHasil];
		for (int i = 0; i < l1.size; i++) {
			isi[i]=l1.getItem(i);
		}
		for (int i =0;i< l2.size;i++){
			isi[i+l1.size]=l2.getItem(i);
			}
		Larik sambung = new Larik(isi);
		return sambung;
	}
	/**
	 ...
	 *            : indeks larik
	 * @param dt
	 *            : item data yang akan disisipkan
	 */
	 ...
	 * 
	 * @param lAsal
	 *            : Array asal yang akan diurutkan
	 * @param status
	 *            : 0-> urut dari kecil ke besar 1-> urut dari besar ke kecil
